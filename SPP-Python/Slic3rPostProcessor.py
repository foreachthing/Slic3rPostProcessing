...
def argumentparser():
    ...
    grp_counter.add_argument('-fc', '--filecounter', action='store_true', default=False,
    ...
    grp_counter.add_argument('-sc', '--setcounter', action='store', metavar='int', type=int,
    ...
    grp_counter.add_argument('-ef', '--easeinfactor', action='store', metavar='int', type=int, default=15,
            ...
            for i, strline in enumerate(lines):
                ...
                if strline and first_layer_height == 0:
                    ...
                    if strline and first_layer_height != 0 and not b_skip_removed and not b_skip_all and not argsnocuramove:
                        ...
                        layerzero = re.search(
                            rf'^(?:G1)\s(?:(?:Z)([-+]?\d*(?:\.\d+)))\s(?:F({regex.findnumber})?)(?:.*layer \(0\).*)$',
